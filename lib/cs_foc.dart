...
List<Club> clubs = [
  Club(
    name: "FOSS",
    imageUrl: "assets/foc club 1 image.jpg",
    description: "A club for FOSS.",
  ),
  Club(
    name: "IEEE",
    imageUrl: "assets/foc club 2 image.jpg",
    description: "A club for IEEE",
  ),
  Club(
    name: "Innovators' Club",
    imageUrl: "assets/foc club 3 image.jpg",
